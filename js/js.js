...
window.onload = function() {
    ...
    alert("Aquesta aplicació web realitzada amb HTML, CSS, JS, XML presenta un examen d'una universitat inventada FundaciónX amb un logo qualsevol creat a partir d'una pàgina web realitzant una recerca per internet. Es tracta d'un formulari que s'autocorregeix amb unes preguntes triades a l'atzar. S'ha utilitzat el navegador Mozilla Firefox per realitzar totes les proves i validar el seu funcionament.");
